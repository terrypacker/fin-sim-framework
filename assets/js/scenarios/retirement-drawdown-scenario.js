...
export const DEFAULT_EVENT_SERIES = [
  new FinSimLib.Core.EventSeries({ id: 'expenses',        label: 'Monthly Expenses',          type: 'MONTHLY_EXPENSES',         interval: 'monthly',  enabled: true,                color: '#F44336' }),
  new FinSimLib.Core.EventSeries({ id: 'dividends',       label: 'Annual Stock Dividends',    type: 'ANNUAL_DIVIDENDS',         interval: 'annually', enabled: true, startOffset: 1, color: '#4CAF50' }),
  new FinSimLib.Core.EventSeries({ id: 'bondInterest',    label: 'Annual Bond Interest',      type: 'ANNUAL_BOND_INTEREST',     interval: 'annually', enabled: true, startOffset: 1, color: '#2196F3' }),
  new FinSimLib.Core.EventSeries({ id: 'checkingInterest',label: 'Annual Checking Interest',  type: 'ANNUAL_CHECKING_INTEREST', interval: 'annually', enabled: true, startOffset: 1, color: '#00BCD4' }),
  new FinSimLib.Core.EventSeries({ id: 'tax',             label: 'Annual Tax Filing',         type: 'ANNUAL_TAX',               interval: 'annually', enabled: true, startOffset: 1, color: '#FF5722' }),
];
