...
export const DEFAULT_EVENT_SERIES = [
  new FinSimLib.Core.EventSeries({ id: 'salary',   label: 'Monthly Salary',          type: 'MONTHLY_SALARY',  interval: 'monthly',   enabled: true,                color: '#4CAF50' }),
  new FinSimLib.Core.EventSeries({ id: 'interest', label: 'Annual Savings Interest',  type: 'ANNUAL_INTEREST', interval: 'annually',  enabled: true, startOffset: 1, color: '#2196F3' }),
  new FinSimLib.Core.EventSeries({ id: 'assets',   label: 'Quarterly Asset Sales',    type: 'SELL_ASSET',      interval: 'quarterly', enabled: true,                color: '#FF9800' }),
  new FinSimLib.Core.EventSeries({ id: 'tax',      label: 'Annual Income Tax Filing', type: 'ANNUAL_TAX',      interval: 'annually',  enabled: true, startOffset: 1, color: '#F44336' }),
];
