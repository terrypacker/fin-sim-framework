...
Use `help/REFERENCE.md` for the complete parameter, panel, journal-action, CLI-tool,
state-field, topic and design-doc surface. It is generated from the code by
...
Narrow searches: `npm run help -- --find <text> [--kind params|panels|actions|tools|state|topics|design]`;
