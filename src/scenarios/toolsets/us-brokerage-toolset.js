...
export const US_BROKERAGE = {
  ...
  types: {
    ...
    actions: [
      ...
      { type: 'BOND_COUPON_TAX',                fields: { amount: ValueType.currency('USD'), federalTaxableAmount: ValueType.currency('USD'), stateTaxableAmount: ValueType.currency('USD'), residency: ValueType.text() } },
      ...
      { type: 'FIXED_INCOME_EARNINGS_TAX',
        fields: { amount: ValueType.currency('USD'), residency: ValueType.text() } },
    ],
  },
